...
<table>
    ...
    <tr>
      <th>Product Title:</th>
      <td><input type="text" name="ptitle" id="product_title" size=50 required></td>
    </tr>
    <tr>
    ...
    <tr>
      <th>Product Price:</th>
      <td><input type="text" name="pprice" id="product_price" required></td>
    </tr>
    <tr>
      <th>Product Description:</th>
      <td><textarea name="pdescription" cols="60" rows="10" id="product_description" required></textarea></td>
    </tr>
    <tr>
      <th>Product Keywords:</th>
      <td><input type="text" name="pkeyword" id="product_keyword"  size=50></td>
    </tr>
    <tr>
      <th colspan="2"> <input  type="submit" value="Insert New Product"></th>
     </tr>
  </table>
   </form>
